      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>List your dive centre on Descend and start taking bookings.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-sm font-medium">Business email</label>
              <Input type="email" placeholder="info@yourdivecenter.com" />
            </div>
            ...
            <p className="text-center text-sm text-muted-foreground">
              Are you a diver?{" "}
              <a href="http://localhost:3000/signup" className="text-primary hover:underline">Sign up on Descend</a>
            </p>
          </CardContent>
        </Card>
      </div>

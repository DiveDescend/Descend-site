    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12 bg-muted/30">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          ...
          <CardDescription>We sent a 6-digit code to your business email. Enter it below to continue.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="text-center space-y-2">
            <p className="text-sm text-muted-foreground">
              Didn&apos;t receive it?{" "}
              <button className="text-primary hover:underline text-sm">Resend code</button>
            </p>
            <p className="text-sm text-muted-foreground">
              Wrong email?{" "}
